package com.example.project5g.ui.dialog.main
...
class MainConfirmPasswordDialog(
    private val context: Context,
    private val customer: Customer,
    private val viewModel: HomeViewModel,
    private val resultContents: String
){
        ...
        buttonConfirm.setOnClickListener {
            ...
            when {
                ...
                inputPassword == customer.password -> {
                    val id = resultContents.substringAfterLast('/')
                    viewModel.scanToPay(id)
