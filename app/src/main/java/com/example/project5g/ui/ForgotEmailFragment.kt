...
class ForgotEmailFragment : Fragment(R.layout.fragment_forgot_email) {
    ...
    override fun onCreateView(
        ...
        phoneTextView.setOnClickListener {
            ...
            val forgotPhoneFragment = ForgotPhoneFragment()
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragmentContainer, forgotPhoneFragment)
